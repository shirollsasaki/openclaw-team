...
|---------|----|---------|--------|
| #general | YOUR_GENERAL_CHANNEL_ID | All-hands, announcements, daily briefs | All |
| #strategy | YOUR_STRATEGY_CHANNEL_ID | Idea evaluation, scoring, prioritization | Richard, Jared, Erlich |
| #engineering | YOUR_ENGINEERING_CHANNEL_ID | Technical feasibility, builds, infra | Gilfoyle, Big Head |
| #content | YOUR_CONTENT_CHANNEL_ID | Copy, campaigns, content calendar | Jared, Monica |
| #research | YOUR_RESEARCH_CHANNEL_ID | Deep dives, competitor intel, market data | Richard, Dinesh |
| #bd | YOUR_BD_CHANNEL_ID | Partnerships, outreach, deal flow | Richard, Erlich |
...
|---------|-----|---------|-----|
| #ops | YOUR_OPS_CHANNEL_ID | System status, cron results, health checks | All agents (post only) |
