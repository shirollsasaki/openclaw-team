...
class Config:
    STRATEGY_NAME = "Strategy 1 V2 + Squeeze (5m)"
    STRATEGY_VERSION = "2.1.0 - Squeeze Filter - 5m Timeframe"
    ...
    # Trading Mode
    SIMULATION_MODE = True  # ⚠️ SIMULATION - Testing 5m timeframe
    ...
    # Execution
    CHECK_INTERVAL = 30  # 5m timeframe = check every 30 seconds
    
    # Discord
    DISCORD_WEBHOOK = os.getenv('DISCORD_WEBHOOK', '')
    
    # Logging
    LOG_FILE = 'strategy1_v2_squeeze_5m.log'
    TRADE_LOG = 'strategy1_v2_squeeze_5m_trades.csv'
