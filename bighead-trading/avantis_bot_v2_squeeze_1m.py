...
class Config:
    STRATEGY_NAME = "Strategy 1 V2 + Squeeze (1m)"
    STRATEGY_VERSION = "2.1.0 - Squeeze Filter - 1m Timeframe"
    ...
    # Trading Mode
    SIMULATION_MODE = True  # ⚠️ SIMULATION - Testing 1m timeframe
    ...
    # Execution
    CHECK_INTERVAL = 15  # 1m timeframe = check every 15 seconds
    
    # Discord
    DISCORD_WEBHOOK = os.getenv('DISCORD_WEBHOOK', '')
    
    # Logging
    LOG_FILE = 'strategy1_v2_squeeze_1m.log'
    TRADE_LOG = 'strategy1_v2_squeeze_1m_trades.csv'
